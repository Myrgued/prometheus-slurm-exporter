...
func TestUnmarshalDiagResponse(t *testing.T) {
	var r DiagResp
	fb := util.ReadTestDataBytes("V0036_slurmdbd_diag.json")
...
func TestUnmarshalJobsResponse(t *testing.T) {
	var r JobsResp
	fb := util.ReadTestDataBytes("V0036_slurmdbd_get_jobs.json")
	err := json.Unmarshal(fb, &r)
	if err != nil {
...
func TestUnmarshalNodesResponse(t *testing.T) {
	var r NodesResp
	fb := util.ReadTestDataBytes("V0036_slurmctld_get_nodes.json")
	err := json.Unmarshal(fb, &r)
	if err != nil {
...
func TestUnmarshalPartitionsResponse(t *testing.T) {
	...
	fb := util.ReadTestDataBytes("V0036_slurmctld_get_partitions.json")
	err := json.Unmarshal(fb, &r)
	if err != nil {
